...
export default function PlacementPrepPage() {
  return (
    <Suspense fallback={<main className="min-h-screen bg-slate-950 px-6 py-16 text-white">Loading placement prep...</main>}>
      <PlacementPrepContent />
    </Suspense>
  );
}
