  ...
  return (
    <>
      ...
      <div className="block md:hidden">
        ...
        >
          <img src={avatarUrl} alt="Profile" className="h-8 w-8 rounded-full border border-white/20" />
          ...
          <div className="fixed inset-x-0 bottom-0 z-50 w-full rounded-t-3xl border-t border-white/10 bg-zinc-950 p-6 pb-8 shadow-2xl md:hidden">
            ...
            <div className="mb-5 rounded-2xl border border-white/10 bg-white/5 p-4">
              <div className="flex items-center gap-3">
                <img src={avatarUrl} alt="Profile" className="h-11 w-11 rounded-full border border-white/20" />
