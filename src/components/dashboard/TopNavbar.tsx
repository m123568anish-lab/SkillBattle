...
export default function TopNavbar({ onMenuClick }: TopNavbarProps) {
  ...
  return (
    <header className="relative z-20 mb-6 overflow-hidden border-b border-white/[0.06] bg-[#0c0a12] shadow-[0_18px_55px_rgba(0,0,0,.28)]">
        ...
        <div className="relative flex shrink-0 items-center gap-2 sm:gap-3">
          {searchOpen && (
            <input
              ...
              placeholder="Search..."
              className="absolute right-0 top-14 z-30 w-52 rounded-full border border-violet-400/30 bg-[#171329] px-4 py-3 text-sm text-white outline-none ring-violet-400/20 placeholder:text-slate-500 focus:ring-4 sm:static sm:top-auto sm:w-48"
              onKeyDown={(event) => {
